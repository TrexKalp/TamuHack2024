  ...
  return (
    <div>
      ...
      <p>
        ...
        the <strong>air above it move faster than the air below</strong>. This creates <strong>"lift"</strong>
      ...
      <p>
        ...
        <strong> movable parts</strong> on the back? Ailerons, flaps, and slats help the pilot
